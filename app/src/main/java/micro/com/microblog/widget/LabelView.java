...
public class LabelView extends View {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LabelView_lv_text_size, sp2px(10));
        ...
        mBackgroundColor = ta.getColor(R.styleable.LabelView_lv_background_color, Color.parseColor("#0AC3BC"));
    ...
    public void setText(int text) {
        mTextContent = UIUtils.getString(text);
        invalidate();
    }

    public void setTextAndBg(int text , int bg) {
        mTextContent = UIUtils.getString(text);
        mBackgroundColor = bg ;
        invalidate();
    }

    public void setTextAndBg(String text , int bg) {
        mTextContent = text;
        mBackgroundColor = bg ;
        invalidate();
    }
