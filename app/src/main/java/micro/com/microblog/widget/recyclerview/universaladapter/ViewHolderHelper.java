package micro.com.microblog.widget.recyclerview.universaladapter;
...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setBigImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageUtils.showBigImage(view,url,null);
        return this;
    }
    public ViewHolderHelper setSmallImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageUtils.showSmallImage(view,url);
        return this;
    }
    ...
    public ViewHolderHelper setItemClickListener(View.OnClickListener listener) {
        mConvertView.setOnClickListener(listener);
        return this ;
    }

    public ViewHolderHelper setGone(int id, boolean empty) {
        View view = getView(id) ;
        view.setVisibility(empty ? View.GONE : View.VISIBLE);
        return this ;
    }

    public ViewHolderHelper  setImageViewTag(int id, int itEyeType) {
        ImageView iv = getView(id) ;
        ImageUtils.showImageViewTag(iv,itEyeType) ;
        return this ;
    }
}
