package micro.com.microblog.widget.recyclerview;
...
public class IRecyclerView extends RecyclerView {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        //System.out.println("----------------->>>onMeasureMethod-----------------<<<");
    }
    ...
    public void setRefreshing(boolean refreshing) {
        if (mStatus == STATUS_DEFAULT && refreshing) {
            ...
            this.mIsAutoRefreshing = false;
            LogUtils.e("isRefresh = " + refreshing + " current status = " + mStatus);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    LogUtils.e("Error processing scroll; pointer index for id " + index + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
                ...
                if (DEBUG) {
                    LogUtils.i("triggerCondition = " + triggerCondition + "; mStatus = " + mStatus + "; dy = " + dy);
                }
                if (triggerCondition) {
    ...
    Animator.AnimatorListener mAnimationListener = new SimpleAnimatorListener() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (DEBUG) {
                LogUtils.i("onAnimationEnd " + getStatusLog(lastStatus) + " -> " + getStatusLog(mStatus) + " ;refresh view height:" + mRefreshHeaderContainer.getMeasuredHeight());
            }
        }
    };
    ...
    private void printStatusLog() {
        LogUtils.i(getStatusLog(mStatus));
    }
